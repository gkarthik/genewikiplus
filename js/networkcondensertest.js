$(document).ready(function(){
	...
	$("#query_button").click(function(){
		...
		$.getJSON("http://genewikiplus.org/api.php?action=ask&q=[[in_gene::"+$("#query_gene").val()+"]]&po=is+associated+with+disease&format=json&callback=?", function(data) {
		generate_condensed_netowork(data);
	});	
	});
$("#export_options ul li").click(function(){
	...
	function generate_condensed_netowork(data)
	{
