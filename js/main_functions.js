...
//Menu functionality.
	...
	//To obtain category of Query term to generate relevant network
		find_category($("#omni_query").val());
	});
	
	function find_category(query_value)
	{
		$.getJSON("http://genewikiplus.org/api.php?action=ask&q=[["+query_value+"]]&format=json&callback=?", function(data) {
